...
def parse(options=None):
    ...
    parser.add_argument('--shift_kms_los',nargs='?',type=float,const=100,help="Adds a shift to the quasar redshift written in the zbest sfile. If a number is not specified the default (100km/s) is used.")
...
def main(args=None):
    ...
    if args.shift_kms_los and not args.zbest:
       log.info("Setting --zbest to true as required by --shift_kms_los")
       args.zbest = True
