...
class TestTemplates(unittest.TestCase):
    ...
    ttest.skipUnless(desi_basis_templates_available, '$DESI_BASIS_TEMPLATES was not detected.')
    test_simple_south(self):
