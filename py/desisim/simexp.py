...
def fibermeta2fibermap(fiberassign, meta):
    ...
    fibermap['TARGET_DEC'] = fiberassign['DEC']
    fibermap['FIBER_RA']   = fiberassign['RA']
    fibermap['FIBER_DEC']  = fiberassign['DEC']
    fibermap['DESIGN_X'] = fiberassign['XFOCAL_DESIGN']
    fibermap['DESIGN_Y'] = fiberassign['YFOCAL_DESIGN']
