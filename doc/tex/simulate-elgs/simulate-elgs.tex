...
%\begin{figure}
%\centering
%\includegraphics[width=0.8\textwidth]{figures/elg_ages.pdf}
%\caption{Relative flux vs rest-frame wavelength for six representative
%  solar-metallicity templates as a function of SSP
%  age. \label{fig:ages}}
%\end{figure}
