#!/usr/bin/env python
"""
statistics for a vanilla DESI survey strategy
"""

import desisim.quicksurvey as qs
import argparse 

parser = argparse.ArgumentParser(description="Statistics from a quick and simplified simulation of a DESI survey")
